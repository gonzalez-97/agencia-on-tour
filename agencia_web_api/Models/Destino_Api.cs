    ...
    public class Destino_Api : Destino
    {
        ...
        public bool Create()
        {
            try
            {
                ...
                Db.Execute("sp_destino_create", p, commandType: CommandType.StoredProcedure);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Update()
        {
            try
            {
                var p = new OracleDynamicParameters();
                AddParametersThis(p);
                Db.Execute("sp_destino_update", p, commandType: CommandType.StoredProcedure);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Delete()
        {
            try
            {
                var p = new OracleDynamicParameters();
                p.Add("Id", this.Id);
                Db.Execute("sp_destino_delete", p, commandType: CommandType.StoredProcedure);
                return true;
            }
            catch (Exception ex)
            {
