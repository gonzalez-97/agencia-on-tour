    ...
    public class Destino_Asociado_Api : Destino_Asociado
    {
        ...
        public bool Create()
        {
            try
            {
                ...
                logger.Info("Destino asociado creado correctamente");
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Update()
        {
            try
            {
                ...
                logger.Info("Destino asociado N°{0} actualizado correctamente", Id); 
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Delete()
        {
            try
            {
                ...
                logger.Info("Destino asociado N°{0} borrado correctamente", Id);
                return true;
            }
            catch (Exception ex)
            {
